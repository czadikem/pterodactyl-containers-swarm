<?php $__env->startSection('title'); ?>
    Nests &rarr; Egg: <?php echo e($egg->name); ?>

<?php $__env->stopSection(); ?>

<?php $__env->startSection('content-header'); ?>
    <h1><?php echo e($egg->name); ?><small><?php echo e(str_limit($egg->description, 50)); ?></small></h1>
    <ol class="breadcrumb">
    ...
    <div class="col-xs-12">
        <div class="nav-tabs-custom nav-tabs-floating">
            <ul class="nav nav-tabs">
                <li class="active"><a href="<?php echo e(route('admin.nests.egg.view', $egg->id)); ?>">Configuration</a></li>
...
<form action="<?php echo e(route('admin.nests.egg.view', $egg->id)); ?>" enctype="multipart/form-data" method="POST">
    <div class="row">
        <div class="col-xs-12">
...
<form action="<?php echo e(route('admin.nests.egg.view', $egg->id)); ?>" method="POST">
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="pName" name="name" value="<?php echo e($egg->name); ?>" class="form-control" />
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="pUuid" readonly value="<?php echo e($egg->uuid); ?>" class="form-control" />
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="pAuthor" readonly value="<?php echo e($egg->author); ?>" class="form-control" />
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="pDockerImages" name="docker_images" class="form-control" rows="4"><?php echo e(implode("\n", $egg->docker_images)); ?></textarea>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <textarea id="pDescription" name="description" class="form-control" rows="8"><?php echo e($egg->description); ?></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="pStartup" name="startup" class="form-control" rows="8"><?php echo e($egg->startup); ?></textarea>
        ...
        <div class="col-xs-12">
            <div class="box">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <select name="config_from" id="pConfigFrom" class="form-control">
                                    ...
                                    <?php $__currentLoopData = $egg->nest->eggs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $o): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($o->id); ?>" <?php echo e(($egg->config_from !== $o->id) ?: 'selected'); ?>><?php echo e($o->name); ?> &lt;<?php echo e($o->author); ?>&gt;</option>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="pConfigStop" name="config_stop" class="form-control" value="<?php echo e($egg->config_stop); ?>" />
                            ...
                            <div class="form-group">
                                ...
                                <textarea data-action="handle-tabs" id="pConfigLogs" name="config_logs" class="form-control" rows="6"><?php echo e(! is_null($egg->config_logs) ? json_encode(json_decode($egg->config_logs), JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES) : ''); ?></textarea>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <textarea data-action="handle-tabs" id="pConfigFiles" name="config_files" class="form-control" rows="6"><?php echo e(! is_null($egg->config_files) ? json_encode(json_decode($egg->config_files), JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES) : ''); ?></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <textarea data-action="handle-tabs" id="pConfigStartup" name="config_startup" class="form-control" rows="6"><?php echo e(! is_null($egg->config_startup) ? json_encode(json_decode($egg->config_startup), JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES) : ''); ?></textarea>
                ...
                <div class="box-footer">
                    ...
                    <a href="<?php echo e(route('admin.nests.egg.export', $egg->id)); ?>" class="btn btn-sm btn-info pull-right" style="margin-right:10px;">Export</a>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/eggs/view.blade.php ENDPATH**/ ?>